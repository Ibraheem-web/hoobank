...
const Hero = () =>(
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className='{`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}'>
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our team of experts uses a to the credit cards most likely to fit your needs. We examine annual percentage rates, annual fees.</p>
    </div>

    <div className={`flex-1 ${styles.flexCenter} relative md:my-0 my-10`}>
      <img src={robot} alt="robot-arm" className='w-full h-full relative z-50 ' />
